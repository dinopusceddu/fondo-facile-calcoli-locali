...
const Index = () => {
  ...
  const TooltipInput = React.memo(({ id, normativo, value, onChange }: {
    id: string;
    normativo: string;
    value: number;
          ...
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="top" className="max-w-sm p-3">
                <p className="text-sm">{normativo}</p>
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        </div>
          ...
          <div className="space-y-6">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <TooltipInput
                  id="fondo2017"
                  normativo="Art. 79 c. 1 CCNL 2022. Art. 67 del CCNL 2018 c. 1 Unico importo del fondo del salario accessorio consolidato all'anno 2017."
                ...
                <TooltipInput
                  id="alte-prof"
                  normativo="Art. 79 c. 1 CCNL 2022. Art. 67 del CCNL 2018 c. 1 Alte professionalità 0,20% monte salari 2001, esclusa la quota relativa alla dirigenza, nel caso in cui tali risorse non siano state utilizzate (da inserire solo se l'importo annuale non è stato già ricompreso nell'unico importo storicizzato)."
                ...
                <TooltipInput
                  id="inc-83-20"
                  normativo="Art. 79 c. 1 CCNL 2022. Art. 67 del CCNL 2018 c. 2 lett. a) Incremento di 83,20 per unità di personale in servizio al 31.12.2015 a valere dall'anno 2019 (risorse non soggette al limite)."
                ...
                <TooltipInput
                  id="inc-stip"
                  normativo="Art. 79 c. 1 CCNL 2022. Art. 67 del CCNL 2018 c. 2 lett. b) Incrementi stipendiali differenziali previsti dall'art. 64 per il personale in servizio (risorse non soggette al limite)."
                ...
                <TooltipInput
                  id="ris-riass"
                  normativo="Art. 79 c. 1 CCNL 2022. Art. 67 del CCNL 2018 c. 2 lett. d) Eventuali risorse riassorbite ai sensi dell'art. 2, comma 3 del decreto legislativo 30 marzo 2001, n. 165/2001 (trattamenti economici più favorevoli in godimento)."
                ...
                <TooltipInput
                  id="somme-trasf"
                  normativo="Art. 79 c. 1 CCNL 2022. Art. 15 del CCNL 1999 c. 1 lett. l) - art. 67 del CCNL 2018 c. 2 lett. e) Somme connesse al trattamento economico accessorio del personale trasferito agli enti del comparto a seguito processi di decentramento e delega di funzioni."
                ...
                <TooltipInput
                  id="rid-stabile"
                  normativo="Art. 79 c. 1 CCNL 2022. Art. 14 del CCNL 1999 c. 3 - art. 67 del CCNL 2018 c. 2 lett. g) Riduzione stabile dello straordinario."
                ...
                <TooltipInput
                  id="taglio-2010"
                  normativo="Eventuale taglio del fondo storicizzato - Art. 9 comma 2 bis D.L. n.78/2010 convertito in L.122/2010 Per il triennio 2011/2013 il tetto dei fondi per le risorse decentrate dei dipendenti e dei dirigenti non può superare quello del 2010 ed è ridotto automaticamente in proporzione alla riduzione del personale in servizio e s.m.i. da sottrarre (da inserire solo se l'importo annuale non è stato già ricompreso nell'unico importo storicizzato)."
                ...
                <TooltipInput
                  id="rid-ata"
                  normativo="Eventuali riduzioni del fondo per personale ATA, posizioni organizzative, processi di esternalizzazione o trasferimento di personale"
                  value={riduzioniATA}
                ...
                <TooltipInput
                  id="decurt-fondo"
                  normativo="Art. 67 c. 1 CCNL 21.05.2018 decurtazione fondo posizioni organizzative e alte professionalità, compreso il risultato, per gli enti con la dirigenza."
                ...
                <TooltipInput
                  id="euro-84-50"
                  normativo="Art. 79 c. 1 lett. b) CCNL 2022 Euro 84,50 per n. unità in servizio al 31.12.2018 con decorrenza dal 01.01.2021 (da calcolarsi per intero sulle unità in servizio, risorse non soggette al limite)."
                  value={euro84_50}
                ...
                <TooltipInput
                  id="ris-stanz"
                  normativo="Art. 79 c. 1 lett. c) CCNL 2022 risorse stanziate dagli enti in caso di incremento stabile della consistenza di personale, in coerenza con il piano dei fabbisogni, al fine di sostenere gli oneri dei maggiori trattamenti economici del personale."
                ...
                <TooltipInput
                  id="diff-2022"
                  normativo="Art. 79 c. 1 lett. d) CCNL 2022 differenziali stipendiali personale in servizio nell'anno 2022 (risorse non soggette al limite)."
                ...
                <TooltipInput
                  id="diff-b3d3"
                  normativo="Art. 79 c. 1-bis CCNL 2022 differenze stipendiali personale inquadrato in B3 e D3 (risorse non soggette al limite)."
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <TooltipInput
                  id="int-var"
                  normativo="Art. 4 del CCNL 5/10/2001 c. 2 - art. 67 del CCNL del 21.05.2018 c. 3 lett. d) Integrazione risorse dell'importo mensile residuo della retribuzione individuale di anzianità e degli assegni ad personam in godimento da parte del personale comunque cessato nell'anno in corso."
                ...
                <TooltipInput
                  id="casino"
                  normativo="Art. 67 del CCNL del 21.05.2018 c. 3 lett. g) Risorse destinate ai trattamenti accessori personale delle case da gioco."
                ...
                <TooltipInput
                  id="monte-1997"
                  normativo="Art. 79 c. 2 lett. b) CCNL 2022 Un importo massimo corrispondente all'1,2 % su base annua, del monte salari dell'anno 1997, relativo al personale destinatario del presente CCNL."
                ...
                <TooltipInput
                  id="int-art62"
                  normativo="Art. 67 del CCNL del 21.05.2018 c. 3 lett. k) Integrazione all'art. 62 del CCNL del 21.02.2018 c. 2 lett. e) somme connesse al trattamento economico accessorio del personale trasferito agli enti del comparto a seguito processi di decentramento e delega di funzioni."
                ...
                <TooltipInput
                  id="ris-adeg"
                  normativo="Art. 79 c. 2 lett. c) CCNL 2022 Risorse finalizzate ad adeguare le disponibilità del Fondo sulla base di scelte organizzative, gestionali e di politica retributiva degli enti, anche connesse ad assunzioni di personale a tempo determinato."
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <TooltipInput
                  id="sponsor"
                  normativo="Art. 15 del CCNL 1/4/1999 c. 1 lett. d) - Art. 67 del CCNL del 21.05.2018 c. 3 lett. a) Somme derivanti dall'attuazione dell'art. 43, L. 449/1997 (contratti di nuove sponsorizzazione – convenzioni – contributi dell'utenza)."
                ...
                <TooltipInput
                  id="notifiche"
                  normativo="Art. 54 CCNL 14/9/2000 - Art. 67 del CCNL del 21.05.2018 c. 3 lett. f) Quota parte rimborso spese per notificazione atti dell'amministrazione finanziaria (messi notificatori)."
                ...
                <TooltipInput
                  id="razion"
                  normativo="ART. 15 c. 1 lett. K), ART. 16, COMMI 4, 5 e 6 DL 98/2011 - Art. 67 del CCNL del 21.05.2018 c. 3 lett. b) Piani di razionalizzazione e riqualificazione della spesa."
                ...
                <TooltipInput
                  id="incentivi"
                  normativo="Art. 15 c.1 lett. k) CCNL 1998-2001 - art. 67 del CCNL del 21.05.2018 c. 3 lett. c) Incentivi per funzioni tecniche, art. 45 dlgs 36/2023, art. 76 dlgs 56/2017, per condono edilizio, per repressione illeciti edilizi, indennità centralinisti non vedenti."
                ...
                <TooltipInput
                  id="giudizio"
                  normativo="Art. 18 c. lett. h) e Art. 67 del CCNL del 21.05.2018 c. 3 lett. c) Incentivi spese del giudizio, compensi censimento e ISTAT."
                ...
                <TooltipInput
                  id="straord"
                  normativo="Art. 15, comma 1, del CCNL 1/4/1999 lett. m) - Art. 67 del CCNL del 21.05.2018 c. 3 lett. e) Eventuali risparmi derivanti dalla applicazione della disciplina dello straordinario di cui all'art. 14."
                ...
                <TooltipInput
                  id="regioni"
                  normativo="Art. 67 del CCNL del 21.05.2018 c. 3 lett. j) Per le Regioni a statuto ordinario e Città Metropolitane ai sensi dell'art. 23 c. 4 del dlgs 75/2017 incremento percentuale dell'importo di cui all'art. 67 c. 1 e 2."
                ...
                <TooltipInput
                  id="non-util"
                  normativo="Art. 80 c. 1 CCNL 2022, Somme non utilizzate negli esercizi precedenti (di parte stabile)"
                ...
                <TooltipInput
                  id="imu-tari"
                  normativo="Legge 145 del 30.12.2018 art. 1 c. 1091 Incentivi legati alla riscossione degli accertamenti IMU e TARI."
                ...
                <TooltipInput
                  id="pasto"
                  normativo="Legge 178/2020 art. 1 c. 870 Risparmi certificati sui buoni pasto non erogati anno 2020."
                  value={risparmiPasto}
                ...
                <TooltipInput
                  id="assunzioni"
                  normativo="Dl 135/2018 art. 11 c. 1 lett. b) Risorse accessorie eventuali per le assunzioni finanziate in deroga."
                ...
                <TooltipInput
                  id="fondo-022"
                  normativo="Art. 79 c. 3 CCNL 2022 0,22% del monte salari anno 2018 con decorrenza dal 01.01.2022, quota d'incremento del fondo proporzionale."
                ...
                <TooltipInput
                  id="tantum"
                  normativo="Art. 79 c. 1 lett. b) CCNL 2022 Euro 84,50 per n. unità in servizio al 31.12.2018, quota una tantum annualità 2021 e 2022."
                ...
                <TooltipInput
                  id="fondo-2022"
                  normativo="Art. 79 c. 3 CCNL 2022 0,22% del monte salari anno 2018 con decorrenza dal 01.01.2022, quota d'incremento del fondo proporzionale, una tantum annualità 2022."
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <TooltipInput
                  id="deroga"
                  normativo="Art. 33 c. 2 dl 34/2019 Eventuale incremento salario accessorio in deroga realizzabile nell'anno."
                ...
                <TooltipInput
                  id="vincoli"
                  normativo="Art. 4 DL 16/2014 Misure conseguenti al mancato rispetto di vincoli finanziari posti alla contrattazione integrativa e all'utilizzo dei relativi fondi"
                  value={misureVincoli}
